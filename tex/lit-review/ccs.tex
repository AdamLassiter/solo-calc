\subsection{Calculus of Communicating Systems}
    ...
    \begin{example*}{(Tea/Coffee Problem)\\}
        ...
        These concepts will be examined further later. % TODO: bisimilarity vs trace
    \end{example*}
    ...
    \begin{remarks}
        ...
        The Tea/Coffee Problem should be kept in mind for the following calculi, particularly for the Solos calculus.
    \end{remarks}
