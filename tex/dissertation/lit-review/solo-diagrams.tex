\subsection{Solo Diagrams}\label{ssec:diagram-definitions}
    ...
    \begin{remark*}
        ...
        These are a combination of a `link graph' and a `place graph', where the collection of nodes and edges forms the former and the subgraphs within boxes dictate the latter.
