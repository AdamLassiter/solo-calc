...
\begin{document}
    ...
    \section{Literature}
        ...
        \input{lit-review/solo-calc} %% TODO: Improve, logical intuition of calculus
        \input{lit-review/solo-diagrams} %% TODO: Probably improve, note on bigraphs, logical intuition to construction of diagrams
        \begin{remarks} %% TODO: Summary/conclusion of lit review
    ...
    \section{Solo Calculus}
        ...
        \input{calculus/calculus} %% TODO: Barendregt variable convention, flattening theorem, α looks horrid but necessary, fairness of reductions
        \input{calculus/repl} %% TODO: Subject parity in alpha equivalence

    \section{Solo Diagrams}
        \input{diagrams/results}
        \input{diagrams/diagrams} %% TODO: Further discussion on pros of diagrams, better to convert expression to diagram
        \input{diagrams/visualisation} %% TODO: Finish section
