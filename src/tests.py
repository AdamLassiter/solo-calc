...
class TestStandardFusion(unittest.TestCase):
...
class TestFlatteningTheorem(unittest.TestCase):                      
...
# TODO: Multiple +ve/-ve test cases
class TestCrossReplicatorFusion(unittest.TestCase):
...
# TODO: Multiple +ve/-ve test cases
class TestInterReplicatorFusion(unittest.TestCase):
...
# TODO: Multiple +ve/-ve test cases
class TestMultiReplicatorFusion(unittest.TestCase):
